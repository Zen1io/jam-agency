...
class Order(models.Model):
    ...
    client_name = models.CharField(max_length=100, verbose_name="Имя клиента", default="Без имени")
    phone = models.CharField(max_length=20, verbose_name="Телефон", default="phone")
    comment = models.TextField(blank=True, verbose_name="Комментарий", default="comment")
    ...
    material = models.CharField(max_length=30, choices=MATERIAL_CHOICES, verbose_name="Материал",
